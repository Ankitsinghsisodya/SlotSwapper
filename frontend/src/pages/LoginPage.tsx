...
function SigninPage() {
    ...
    // Kept for future use when email login is re-enabled
    // @ts-expect-error Kept for future use when email login is re-enabled
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-10">
                    ...
                    <div className="mb-6">
                        ...
                        >
                            ...
                            {isloading ? "Loading..." : "Sign in with Google (Recommended)"}
                        </button>
                    </div>
